    ...
    <footer className="bg-gray-900 text-white">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company info */}
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">Liyana Nour</h3>
            <p className="text-gray-400 mb-4">
              Exklusive Parfüm-Kollektionen mit innovativer Sprachsteuerung für ein einzigartiges Einkaufserlebnis.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          ...
          <p className="text-gray-500 text-sm mt-2">
            Mit KI-gestützter Sprachsteuerung für barrierefreies Einkaufen
          </p>
        </div>
      </div>
    </footer>
